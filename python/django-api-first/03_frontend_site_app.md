# 03 - Frontend Site App
## Overview
Serve server-rendered pages from a dedicated frontend app.
## Learning Goals
...
## Core Example
`python
def home(request):`n    return render(request, "frontend_site/home.html")
`
## Exercises
...
---
⬅️ Previous: [02 - Project Bootstrap and Environment](./02_project_bootstrap.md)
➡️ Next: [04 - Backend API App](./04_backend_api_app.md)
