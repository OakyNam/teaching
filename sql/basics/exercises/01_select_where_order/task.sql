-- Lesson 01 Exercises: SELECT, WHERE, ORDER BY, LIMIT
...
-- Task 1: Return customer id, name, and country for customers in Egypt.
-- Order by name ascending.
-- YOUR QUERY HERE

-- Task 2: List the three most expensive products.
-- Show sku, name, category, and price.
-- YOUR QUERY HERE

-- Task 3: Find orders placed on or after 2024-04-05 that are not cancelled.
-- Order by order_date descending, then id descending.
-- YOUR QUERY HERE

-- Task 4: Show the first two customers from the United States who signed up most recently.
-- YOUR QUERY HERE
