-- Lesson 07 Exercises: SQL injection protection
...
-- Task 1: Replace an unsafe concatenated customer lookup with a prepared statement.
-- Unsafe idea: SQL text plus raw user input.
-- YOUR QUERY HERE

-- Task 2: Write a prepared statement that filters orders by status and shipping_country.
-- YOUR QUERY HERE

-- Task 3: Execute your safe customer lookup with the value
-- 'alice@example.com'' OR ''1''=''1' and verify it behaves like plain text input.
-- YOUR QUERY HERE

-- Task 4: Write a comment explaining why ORDER BY column names should come from an allow-list
