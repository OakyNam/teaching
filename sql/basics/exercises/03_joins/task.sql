...
-- Task 1: Use an INNER JOIN to list order_id, customer_name, and shipping_country.
-- YOUR QUERY HERE

-- Task 2: Use a LEFT JOIN to show each customer and the number of orders they placed.
-- Include customers with zero orders.
-- YOUR QUERY HERE

-- Task 3: Use a RIGHT JOIN to show every product and the total quantity ordered.
-- Products with no sales should show 0.
-- YOUR QUERY HERE

-- Task 4: Use a self-join on customers to show each customer and the customer who referred them.
-- YOUR QUERY HERE
