-- Lesson 04 Exercises: subqueries and CTEs
...
-- Task 1: Write a subquery in WHERE that returns customers who placed at least two orders.
-- YOUR QUERY HERE

-- Task 2: Write a subquery in SELECT that shows each product plus how many order lines reference it.
-- YOUR QUERY HERE

-- Task 3: Use a subquery in FROM to calculate revenue per order, then select only orders above 500.
-- YOUR QUERY HERE

-- Task 4: Use a CTE to calculate total spend per customer, then return the top two customers by spend.
-- YOUR QUERY HERE
