-- Lesson 02 Exercises: GROUP BY, HAVING, and aggregates
...
-- Task 1: Count how many customers signed up in each country.
-- Show country and total_customers.
-- YOUR QUERY HERE

-- Task 2: Summarize revenue by product category.
-- Show category, units_sold, and category_revenue.
-- YOUR QUERY HERE

-- Task 3: For each customer, show the number of distinct orders and total spend
-- using only orders that are not cancelled.
-- YOUR QUERY HERE

-- Task 4: Return only categories whose total revenue is greater than 300.
-- Use HAVING and order by revenue descending.
-- YOUR QUERY HERE
