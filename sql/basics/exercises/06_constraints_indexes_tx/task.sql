-- Lesson 06 Exercises: constraints, indexes, and transactions
...
-- Task 1: Create an index that helps look up orders by customer_id and order_date.
-- YOUR QUERY HERE

-- Task 2: Create an index that helps sort products within a category by price.
-- YOUR QUERY HERE

-- Task 3: Start a transaction that inserts order 1007 for customer 5 and one order_item row, then commits.
-- YOUR QUERY HERE

-- Task 4: Start a transaction that changes order 1001 to cancelled, then rolls it back.
-- Add a SELECT afterward to prove the original value was preserved.
-- YOUR QUERY HERE
