-- Lesson 03 Example: INNER JOIN, LEFT JOIN, RIGHT JOIN, and self-join
...
-- INNER JOIN: orders matched to the customer who placed them.
SELECT o.id AS order_id, c.name AS customer_name, o.status, o.order_date
FROM orders o
INNER JOIN customers c ON c.id = o.customer_id
ORDER BY o.id;

-- LEFT JOIN: every customer appears, even if they have not ordered yet.
...
-- RIGHT JOIN: every product appears, even products that were never ordered.
...
-- Self-join: show who referred whom.
