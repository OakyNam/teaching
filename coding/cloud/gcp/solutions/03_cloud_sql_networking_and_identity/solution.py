"""Reference solution for Cloud SQL connection settings."""
...
def build_connection_string() -> str:
    ...
    sqlite_path = Path(__file__).with_name('cloud_sql_exercise.sqlite3')
...
def run_local_demo(connection_string: str) -> None:
    ...
    with sqlite3.connect(sqlite_path) as conn:
        ...
        conn.execute('INSERT INTO checks (name, passed) VALUES (?, ?)', ('service-account-ready', 1))
